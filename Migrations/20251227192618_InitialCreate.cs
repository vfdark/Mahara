        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExchangeRequests_AspNetUsers_ReceiverUserId",
                        column: x => x.ReceiverUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExchangeRequests_AspNetUsers_SenderUserId",
                        column: x => x.SenderUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExchangeRequests_Skills_SkillOfferedId",
                        column: x => x.SkillOfferedId,
                        principalTable: "Skills",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExchangeRequests_Skills_SkillRequestedId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExchangeRequests_ReceiverUserId",
                table: "ExchangeRequests",
                column: "ReceiverUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ExchangeRequests_SenderUserId",
                table: "ExchangeRequests",
                column: "SenderUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ExchangeRequests_SkillOfferedId",
                table: "ExchangeRequests",
                column: "SkillOfferedId");

            migrationBuilder.CreateIndex(
                name: "IX_ExchangeRequests_SkillRequestedId",
                table: "ExchangeRequests",
